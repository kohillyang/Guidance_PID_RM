...
private:
	...
	void rc_channels_subscriber_callback(dji_sdk::RCChannels rc_channels)
	{
        ...
        printf("roll:%f ,pitch:%f ,yaw:%f, throttle:%f ,gear:%f", this->rc_channels.roll,this->rc_channels.pitch,this->rc_channels.yaw,this->rc_channels.throttle,this->rc_channels.gear);
